...
new Vue({
  ...
  methods: {
    ...
    validate: function() {
      var isPass = this.configData.source.items.some(function(item) {
        return item.img == '' || item.text == ''
      });
      if (isPass == true) {
        return false;
      }
    ...
    addSele: function() {
      this.configData.source.items.push({
        text: '',
        audio: '',
        img: '',
        sugarImg: ''
    ...
    delSele: function(item) {
      this.configData.source.items.remove(item);
    },
    addTg: function(item) {
