...
var updata2 = [0, 1, 2, 3, 4, 5, 6];
var updataTime = ['once', 'repeatly'];
var Data = {
  configData: {
    bg: "",
    desc: "",
    ...
    source: {
      position:[61,108,72,117,267,272,278],
      time: 'once',
      personPos: '0',
      diceNum: '2',
      personImg: '',
...
new Vue({
  ...
  methods: {
    ...
    validate: function() {
      var postions = this.configData.source.position;
