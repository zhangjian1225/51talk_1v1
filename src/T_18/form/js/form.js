...
new Vue({
  ...
  methods: {
    ...
    validate: function() {
      // var isPass = this.configData.source.boxList.some(function(item){
      //     return item.img == ''
      // });
      // if(isPass == true){
      //     return false;
      // }
      if (!this.configData.source.part || !this.configData.source.person) {
        return false;
      }
      return true;
    },
    ...
    addSele: function() {
      this.configData.source.boxList.push({
        img: ''
      });
    },
    delSele: function(item) {
      this.configData.source.boxList.remove(item);
    },
    addTg: function(item) {
