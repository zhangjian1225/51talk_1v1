...
new Vue({
  ...
  methods: {
    ...
    validate: function() {
      if(this.configData.source.img == '' && this.configData.source.startPos == '' && this.configData.source.endPos == ''){
          return false;
      }
      return true;
    },
    onSend: function() {
      ...
      if (val) {
        if (this.configData.source.startPos >0 && this.configData.source.startPos <801 && this.configData.source.endPos >0 && this.configData.source.endPos <801) {
